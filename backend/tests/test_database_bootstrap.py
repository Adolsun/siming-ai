...
def test_fresh_database_is_initialized_and_versioned():
    with TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            assert result.schema_revision == revision == "300a8_unified_conversation_scope"
...
def test_recognized_legacy_database_is_backed_up_and_preserved():
    with TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            assert revision == "300a8_unified_conversation_scope"
        finally:
            engine.dispose()
...
def test_alpha1_database_upgrades_through_gateway_sync():
    with TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            assert result.mode == "migrated"
            assert result.schema_revision == "300a8_unified_conversation_scope"
