...
class SqlAlchemyNarrativeGovernanceCommands:
    ...
    def update_status(
        ...
        safe_values = {key: value for key, value in values.items() if key in allowed_fields}
        ...
        if target_chapter_id:
            target_chapter = self._chapter_evidence.get(
                session,
        ...
        if resolved_chapter_id:
            resolved_chapter = self._chapter_evidence.get(
                session,
                project_id=project_id,
