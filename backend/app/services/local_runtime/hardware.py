...
def detect_hardware() -> HardwareProfile:
    ...
    if vram_gb >= 24 and ram_gb >= 32:
        profile, model, context = "quality", "qwen3.5-27b-q4", 262144
    elif vram_gb >= 12 or ram_gb >= 32:
        profile, model, context = "standard", "qwen3.5-9b-q4", 262144
    else:
        profile, model, context = "light", "qwen3.5-4b-q4", 262144
