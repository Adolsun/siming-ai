  ...
  useEffect(() => {
    ...
    if (token) {
      const entries: Record<string, string> = {
        ...
        '--ant-color-success-bg': token.colorSuccessBg || '',
        '--ant-color-success-border': token.colorSuccessBorder || '',
        '--ant-color-success-text': token.colorSuccessText || '',
        '--ant-color-warning': token.colorWarning || '',
        '--ant-color-error': token.colorError || '',
        '--ant-color-error-bg': token.colorErrorBg || '',
        '--ant-color-error-border': token.colorErrorBorder || '',
        '--ant-color-error-text': token.colorErrorText || '',
        '--ant-color-info-bg': token.colorInfoBg || '',
        '--ant-color-info-border': token.colorInfoBorder || '',
        '--ant-color-info-text': token.colorInfoText || '',
        '--ant-color-warning-bg': token.colorWarningBg || '',
        '--ant-color-warning-border': token.colorWarningBorder || '',
        '--ant-color-warning-text': token.colorWarningText || '',
